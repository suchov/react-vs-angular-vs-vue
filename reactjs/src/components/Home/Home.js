...
class Home extends Component {
  render() {
    ...
    let subheading = "Lorem inpsum, dolor sit amet, consetetur adipiscing elit, sed to eius ...";
    return (
      <div>
        <section className="hero">
          <div className="hero-dody">
            <div className="container">
              <h1 className="title">{ heading }</h1>
              <div className="is-two-thirds column is-paddingless">
                <h2 className="subtitle is-4">{ subheading }</h2>
              </div>
              <a className="button is-large is-primary" id="learn" href="faq">Learn more</a>
            </div>
          </div>
        </section>
        ...
        <section className="section">
          <div className="container">
            <div className="columns pd is-desktop">
              <div className="column is-1 has-text-centred">
              ...
              <div className="column">
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incicicunt ut labore...</p>
              </div>
            </div>
          </div>
            ...
            <div className="column">
              <div className="card">
                <div className="card-content">
                  ...
                  <p className="subtitle">- Gray Simon</p>
                </div>
              </div>
            </div>
            <div className="column">
