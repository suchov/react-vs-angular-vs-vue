  ...
  <div id="app">
    <div class="navbar has-shadow">
      <div class="container">
        ...
        <span class="navbar-toggle navbar-burger" v-on:click="toggleNav" v-bind:class="{ 'is-active': isActive }">
          <span></span>
          <span></span>
          <span></span>
        </span>

        <div class="navbar-right navbar-menu" v-bind:class="{ 'is-active': isActive }">
