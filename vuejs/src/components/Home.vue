    ...
    <section class="hero">
      <div class="hero-dody">
        <div class="container">
          ...
          <a class="button is-large is-primary" id="learn" href="#">Learn more</a>
        </div>
      </div>
    </section>
    ...
    <section class="section">
      <div class="container">
        <div class="columns pd is-desktop">
          <div class="column is-1 has-text-centred">
...
export default {
  ...
  data () {
    return {
      ...
      subheading: 'Lorem ipsum dolor sit amet, counsecteur adipiscing elit, sed do eiusmod ...'
    }
  }
}
</script>
